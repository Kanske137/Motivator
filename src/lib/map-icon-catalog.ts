  ...
  },
  {
    ...
    iconNode: [
      [
        "path",
        {
          d: "M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm0 4.5-3.6 2.6 1.4 4.2h4.4l1.4-4.2L12 6.5zM6.2 11.5l-1.6 1.2.7 2.6 2-.3 1.2-3.7-2.3-1.8-.0.0zm11.6 0-2.3 1.8 1.2 3.7 2 .3.7-2.6-1.6-1.2zM9.5 16.2l-1.6 1.8 1.4 1.5 2.7-1V16h-2.5zm5 0H12v2.5l2.7 1 1.4-1.5-1.6-1.8z",
          fillRule: "evenodd",
        },
      ],
    ],
  },
  {
    ...
    iconNode: [
      [
        "path",
        {
          d: "M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm0 3.5L8 8l1.5 4.5h5L16 8l-4-2.5zm-6 5.2-1 .8.7 3 2.2.5 1.3-3.6L6 10.7zm12 0-3.2 1 1.3 3.5 2.2-.5.7-3-1-.8zM10 16l-1.5 2 1 1.7 2.5-.6V16h-2zm4 0v3.1l2.5.6 1-1.7-1.5-2h-2z",
          fillRule: "evenodd",
        },
      ],
    ],
